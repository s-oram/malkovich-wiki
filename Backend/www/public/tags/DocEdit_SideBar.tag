<docedit_sidebar class="docedit_sidebar">
    <div>Attached Files</div>
    <div id="DocEditFileBrowserContainer" class="FGRows FGCellGrow">
        <!--<div class="component-filebrowser"></div>-->
        <div id="dropzone1" class="component-uploadfile FileDropZone">
            <div class="FileBrowserContainer">
                <docedit_filebrowser global_options={ opts.global_options }></docedit_filebrowser>
            </div>

            <div class="component-uploadfile-ready-msg DropHereMessage"><div>Drop files here or &nbsp; <a>browse...</a></div></div>
            <input type="file" class="component-uploadfile-fileinput" name="files[]" multiple>
        </div>
        <div class="UploadPlaceHolders"></div>
    </div>

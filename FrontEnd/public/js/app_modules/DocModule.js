...
TDocModule.prototype.Ajax_DeleteFile = function(docName, fileName) {
    ...
    var RequestUrl = this.AppConfig.ApiUrl.Root + this.AppConfig.ApiUrl.Files + sprintf("/delete/%s/%s", docName, fileName);
...
TDocModule.prototype.Ajax_ShowFile = function(docName, fileName) {
    var FunctionResult = null;
    ...
    var RequestUrl = this.AppConfig.ApiUrl.Root + this.AppConfig.ApiUrl.Files + sprintf("/show/%s/%s", docName, fileName);
    console.log(RequestUrl);

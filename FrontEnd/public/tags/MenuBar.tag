<menubar class="MainMenuBar FGColumns">
    <div class="FGColumns WikiMenu">
        ...
        <!--
        <div class="MenuBarFlexButton">
            <span class="ButtonText">List</span>
        </div>
        -->
        <div id="PageTitle" class="MenuBarElement">
           { '#' + DataStores.PageData.PageName }
        </div>
    </div>
    <div class="FGColumns PageMenu">
        <div class="MenuBarFlexButton EditDocButton">
            <span class="ButtonText">Edit</span>
        </div>
        <div class="MenuBarFlexButton SettingsButton">

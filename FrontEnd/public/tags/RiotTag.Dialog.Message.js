riot.tag('riotdialog-message', '<div class="PopUpWrapper"> <div class="DialogContainer"> <div class="Content"> <div if="{Data.DialogTitle}" class="DialogTitle">{Data.DialogTitle}</div> <div class="DialogMessage"></div> <ul class="DialogButtons"> <li each="{Data.MsgButtons}" class="{ButtonClass}" data-dialogElement="DialogButton" data-tag="{tag}">{caption}</li> </ul> </div> </div> </div>', 'class="RiotDialog MessageDialog"', function(opts) {
"use strict";
var self = this;

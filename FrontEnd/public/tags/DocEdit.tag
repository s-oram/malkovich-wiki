<docedit class="DocEditComponent">

    <div id="EditPageMainEditArea"  class="docedit_main">
        <div>
            Editing: { DataStores.PageData.PageName }
        </div>

        <form id="DocEditForm" class="FGCellGrow FGRows" >
            <div class="FormGroup hidden form-error-message"></div>
            <div class="FormGroup hidden form-success-message"></div>
            <textarea name="DocText" id="DocTextEdit" class="FormGroup FGCellGrow"></textarea>
            <div class="FormGroup FormButtonContainer">
                <ul class="InlineList">
                    <li><input class="Button btn btn-primary" type="submit" name="save" value="Save Changes">
                    <li><input class="Button btn btn-default" type="submit" name="cancel" value="Cancel">
                </ul>
            </div>
        </form>
    </div>

    <docedit_sidebar global_options={ opts } ></docedit_sidebar>
